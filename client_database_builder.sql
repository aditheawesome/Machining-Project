...
CREATE TABLE `builder` (
  `builder_id` INTEGER PRIMARY KEY AUTOINCREMENT DEFAULT 0,
...
-- INSERT INTO `builder` (name_, email_address, isapproved) VALUES ('not a builder','builder.example@gmail.com', 1),('Alexis', 'alexis@gmail.com', 1),('Becky', 'becky@gmail.com', 1),('Carlos', 'carlos@gmail.com', 1);
SELECT * FROM builder;
